              ...
              <tbody>
                <tr>
                  <td>
                    <figure className="itemside">
                      <div className="aside">
                        <img src={require("../../assets/images/items/1.jpg")} className="img-sm" />
                      </div>
                ...
                <tr>
                  <td>
                    <figure className="itemside">
                      <div className="aside">
                        <img src={require("../../assets/images/items/2.jpg")} className="img-sm" />
                      </div>
                      <figcaption className="info">
                        <a href="#" className="title text-dark">
                ...
                <tr>
                  <td>
                    <figure className="itemside">
                      <div className="aside">
                        <img src={require("../../assets/images/items/3.jpg")} className="img-sm" />
                      </div>
                      <figcaption className="info">
                        <a href="#" className="title text-dark">
                          Another name of some product goes just here as a demo
                          text{" "}
                        </a>
